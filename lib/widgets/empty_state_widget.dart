...
/// Reusable empty state widget for embedding in screens.
/// Types:
/// - 'no-groups': Full page empty state with CTA
/// - 'no-expenses': Simple inline empty state
/// - 'new-cycle': New cycle started message
/// - 'no-expenses-new-cycle': Empty cycle with animated icon
/// - 'zero-waste-cycle': Compact inline for dark cards
