...
export function MemberChange({ groupName, memberPhone, action, onConfirm, onBack }: MemberChangeProps) {
  return (
        ...
        <div className="text-center max-w-[320px]">
          ...
          <div className="text-[17px] text-[#6B6B6B] mb-2">
            {action === 'leave' 
              ...
              : `${memberPhone} will be removed from this group`
            }
          </div>
