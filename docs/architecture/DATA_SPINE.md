...
| `type` | `String` | `'cycle_settlement_started'`, `'payment_initiated'`, `'payment_pending'`, `'payment_confirmed_by_payer'`, `'payment_confirmed_by_receiver'`, `'payment_failed'`, `'payment_disputed'`, `'cash_confirmation_requested'`, `'cash_confirmed'`, `'cycle_fully_settled'`, `'cycle_archived'`, `'pending_reminder'` |
| `pendingCount` | `int?` | Number of members pending settlement (for `pending_reminder` events) |
