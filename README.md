...
| **Expenses** | Add via Smart Bar (natural language, parsed by optional Groq/Llama integration) or manual form. Edit/undo; description, date, amount; splits: Even, Exact, or Exclude. |
